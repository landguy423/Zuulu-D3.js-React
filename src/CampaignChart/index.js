...
class Chart extends React.Component {
  ...
  componentDidMount() {
    ...
    this.width = this.props.size.width - this.margin.left - this.margin.right;
  ...
  draw(props) {
    ...
    const domainY = [0, d3.max(data.map(d => d.value)) * props.upperBorder];
